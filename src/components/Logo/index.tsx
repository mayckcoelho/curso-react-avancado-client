...
const Logo = ({
  ...
  <S.Wrapper color={color} size={size} hideOnMobile={hideOnMobile}>
    ...
    >
      ...
      />
      <path
        d="M7.592 7c-5.11 2.755-4.519 5-4.519 7.5M57.274 26v1M3.052 18v2m54.222 10v5"
        stroke="#fff"
        strokeOpacity=".4"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      <ellipse
        rx="1.506"
        ry="1.5"
        transform="translate(44.723 13.557)"
        fill="#0A0D27"
      />
      <ellipse
        rx="1.506"
        ry="1.5"
        transform="translate(49.743 17.5)"
        fill="#0A0D27"
      />
      <ellipse
        rx="1.506"
        ry="1.5"
        transform="translate(44.723 21.5)"
        fill="#0A0D27"
      />
      <ellipse
        rx="1.506"
        ry="1.5"
        transform="translate(39.703 17.5)"
        fill="#0A0D27"
      />
      <path
        className="text"
      ...
      <defs>
        ...
        >
          <stop stopColor="#FF725F" />
          <stop offset="1" stopColor="#F062C0" />
          <stop offset="1" stopColor="#F231A5" />
        </linearGradient>
      </defs>
    </svg>
  </S.Wrapper>
